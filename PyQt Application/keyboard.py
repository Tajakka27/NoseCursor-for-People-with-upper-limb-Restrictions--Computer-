...
class KeyboardWidget(QWidget):
    ...
    def do_caps(self):
        ...
        self.buttonAdd()
        self.cap_button.setText("CapsLK")
    ...
    def initUI(self):
        ...
        self.text_box.setFont(QFont('Arial', 40))
        ...
        self.layout.addWidget(space_button, 5, 2, 1, 5)
        ...
        space_button.setStyleSheet("background-color: #ebf0f5 ; border: 1px solid black;")
        ...
        self.layout.addWidget(back_button, 5, 0, 1, 2)
        ...
        back_button.setStyleSheet("background-color: #ebf0f5 ; border: 1px solid black;")
        ...
        self.cap_button.clicked.connect(self.do_caps)
        self.cap_button.setStyleSheet("background-color: #ebf0f5 ; border: 1px solid black;")
        # Done button
        ...
        sym_button.setFont(QFont('Arial', 20))
        sym_button.KEY_CHAR = Qt.Key_Down
        # Set the background color to sky blue
        sym_button.setStyleSheet("background-color: #ebf0f5 ; border: 1px solid black;")
        sym_button.setStyleSheet("""
            QPushButton {
        ...
        self.layout.addWidget(sym_button, 4, 9, 2, 1)
...
class KeyboardUI(QMainWindow):
    ...
    def einiUI2(self, obj):
        ...
        layout.addWidget(self.keyboardWidget, 0, 0, 5, 5)
        ...
        self.setGeometry(0, 50, screen.width()-0, screen.height()-0)
